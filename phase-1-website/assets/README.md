# Dermacue — image assets

Add clinic photos here before go-live. Commit JPG/WebP files to this folder (keep each file under ~500 KB for fast mobile load).
...
See `../plans/phase-1-mvp-website.md` → **Add photos** for copy-paste HTML/CSS steps.
